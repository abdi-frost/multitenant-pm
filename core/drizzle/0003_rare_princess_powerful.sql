...
ALTER TABLE "employees" DROP CONSTRAINT "employees_organizationId_organizations_id_fk";
--> statement-breakpoint
ALTER TABLE "tenants" ALTER COLUMN "approvedBy" SET DATA TYPE varchar(36);--> statement-breakpoint
ALTER TABLE "tenants" ALTER COLUMN "rejectedBy" SET DATA TYPE varchar(36);--> statement-breakpoint
ALTER TABLE "tenants" ADD COLUMN "ownerId" varchar(36) NOT NULL;--> statement-breakpoint
